	...
	<div id="contents">
		...
		<div id="main">
			...
			<table class="updatecheck">
				...
				<tr>
					<th>性別:</th>
					<c:if test="${updateForm.gender==1}">
						<td>男性</td>
					</c:if>
					<c:if test="${updateForm.gender==2}">
						<td>男性</td>
					</c:if>
					<td></td>
				</tr>
				...
				<tr>
					<th>権限:</th>
					<c:if test="${updateForm.authority==1}">
						<td>一般</td>
					</c:if>
					<c:if test="${updateForm.authority==2}">
						<td>一般</td>
					</c:if>
				...
				<tr>
					<th>部署名:</th>
					<c:if test="${updateForm.deptId == 1}">
						<td>営業部</td>
					</c:if>
					<c:if test="${updateForm.deptId == 2}">
						<td>経理部</td>
					</c:if>
					<c:if test="${updateForm.deptId == 3}">
						<td>総務部</td>
					</c:if>
				</tr>
			</table>
