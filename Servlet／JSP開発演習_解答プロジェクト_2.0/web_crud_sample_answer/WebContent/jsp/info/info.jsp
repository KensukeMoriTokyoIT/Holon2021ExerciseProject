...
<body>
	<div id="contents">
		...
		<div class="select_func">
			<form id="selectform" method="post" action="<%=request.getContextPath()%>/public/InfoSelectServlet">
			...
			<form method="get" action="<%=request.getContextPath()%>/public/SelfUpdateInputServlet">
				<input type="hidden" name="empId" value="${user.empId}" />
				<input type="submit" value="社員情報更新" />
			</form>

			<form method="post" action="<%=request.getContextPath()%>/public/SelfPasswordInputServlet">
				<input type="hidden" name="empId" value="${user.empId}" />
