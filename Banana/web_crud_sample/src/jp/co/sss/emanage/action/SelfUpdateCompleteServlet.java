...
/**
 * Servlet implementation class SelfUpdateCompleteServlet
 */
@WebServlet("/SelfUpdateCompleteServlet")
public class SelfUpdateCompleteServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("jsp/info/self_update_complete.jsp").forward(request,response);
	}
